  ...
  return (
    ...
    >
      <div
        ...
        className={`relative ${bgcolor} rounded-md shadow p-3 duration-500 ${
          open ? 'scale-100 opacity-100 transition-all' : 'scale-125 opacity-0'
        }`}
      >
        <button
          onClick={onClose}
        ...
        {/* Unmount children when closed so embedded media (e.g. YouTube iframe) stops playing */}
        {open && children}
      </div>
    </div>
  );
